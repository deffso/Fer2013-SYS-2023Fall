...
# Assuming your model is named resnet18
...
month = now.month
day = now.day
log_file_path = 'training_logs_尺寸311_attention_双层'+str(month)+'月'+str(day)+'日'+str(hour)
...
for epoch in range(epochs):
    ...
    if test_epoch_accuracy > best_accuracy:
        ...
        torch.save(resnet18.state_dict(), log_file_path+'best_resnet18_model.pth') 
